...
8. 在右侧“产品专家”面板点击“查看卡片”，检查需求摘要、影响模块和待确认问题。
9. 点击“找相似”，检查是否能看到相似需求和相似原因。
10. 点击“看演进”，检查是否能看到版本时间线、变更事件、风险等级和建议动作。
11. 点击“出方案”，检查是否能看到推荐方案、备选方案、风险、验收清单和证据来源。
...
- Product Expert v0.3：新增“产品专家”面板，按规则识别需求分组和版本，支持需求卡片、卡片完整度评分、相似历史需求、需求演进时间线、规则版方案推荐、专项评测脚本，并提供两个文档版本的变更分析骨架。
- Domain Terms v1：内置通用术语表会跟随代码迁移；“挖术语”候选来自当前电脑已索引文档和低分/拒答 trace，换办公电脑后需要重新索引并重新挖候选。
